...
if __name__ == "__main__":
    ...
    window.add_data_source("exp", lambda x: math.exp(x % 5), "b")  # Blue for exponential data
    window.add_data_source("sqrt", lambda x: math.sqrt(abs(x % 10)), "y")  # Yellow for square root data
